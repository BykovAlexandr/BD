...
фантома. 
Записать протокол выполнения сценариев. 
Установить в обоих сеансах уровень изоляции SERIALIZABLE. Выполнить сценария проверки 
фантома. 
Записать протокол выполнения сценария. 
 </h3>
[File](/Быков_ПМИ-32БО(ЛАБ7).docx)
